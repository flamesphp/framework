...
use Flames\Http\Cookie\CookieJarInterface;
        ...
        return static function (callable $handler): callable {
            return static function ($request, array $options) use ($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('cookies must be an instance of Http\Cookie\CookieJarInterface');
                }
            ...
            return static function (RequestInterface $request, array $options = []) use ($handler, $logger, $formatter, $logLevel) {
                return $handler($request, $options)->then(
                    ...
                    static function ($reason) use ($logger, $request, $formatter): PromiseInterface {
                        ...
                        $message = $formatter->format($request, $response, Promise\Create::exceptionFor($reason));
