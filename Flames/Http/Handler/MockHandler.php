...
class MockHandler implements \Countable
{
     ...
     * {@see \Flames\Http\Psr\Http\Message\ResponseInterface} objects, Exceptions,
    ...
    public function __invoke(RequestInterface $request, array $options): PromiseInterface
    {
        ...
        $response = $response instanceof \Throwable
            ? \Flames\Http\Promise\Create::rejectionFor($response)
            : \Flames\Http\Promise\Create::promiseFor($response);
        ...
        return $response->then(
            ...
            function ($reason) use ($request, $options) {
                ...
                return \Flames\Http\Promise\Create::rejectionFor($reason);
            }
        );
    }
