...
use Flames\Http\Cookie\CookieJar;
use Flames\Http\Exception\GuzzleException;
...
class Client implements ClientInterface, Psr\Http\Client\ClientInterface
{
     ...
     *   Http\Promise\PromiseInterface that is fulfilled with a
     ...
     *
     * @see \Flames\Http\RequestOptions for a list of available request options.
     */
     ...
     *                       request and to the transfer. See \Http\RequestOptions.
     */
     ...
     * @param array               $options Request options to apply. See \Http\RequestOptions.
     */
     ...
     *
     * @param array $options See \Http\RequestOptions.
     */
