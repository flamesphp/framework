    ...
    public function match(string $requestUrl = null, string $requestMethod = null)
    {
        ...
        foreach ($this->routes as $handler) {
            ...
            if ($route === '*') {
                ...
                // Check if last character before param is a slash, because it could be optional if param is optional too (see https://github.com/dannyvankooten/Router/issues/241)
